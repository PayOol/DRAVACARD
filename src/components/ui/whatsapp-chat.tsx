  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className={`bg-gradient-to-r from-blue-600 to-indigo-800 hover:from-blue-700 hover:to-indigo-900 text-white rounded-full p-3.5 shadow-lg flex items-center justify-center transition-all duration-300 ${isOpen ? 'rotate-90' : ''}`}
