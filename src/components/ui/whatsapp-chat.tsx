      ...
      >
        {isOpen ? (
          ...
          <>
            ...
            <div className="absolute -inset-2 rounded-full border-dashed border-white/5 animate-[spin_20s_linear_infinite] opacity-50"></div>
            
            {/* Radar-like scan effect */}
            <div className="absolute inset-0 overflow-hidden rounded-full">
              <div className="absolute top-1/2 left-1/2 w-[200%] h-1 bg-white/20 origin-left rotate-0 animate-[spin_3s_linear_infinite]"></div>
            </div>
          </>
        )}
      </button>
